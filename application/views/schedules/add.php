        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?= base_url('schedules/add') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="start_time" name="start_time" type="time" value="<?= set_value('start_time') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="finish_time" name="finish_time" type="time" value="<?= set_value('finish_time') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control" id="subject_id" name="subject_id">
                                ...
                                <?php foreach ($subject as $row) : ?>
                                    <?php if ($row['id'] == set_value('subject_id')) : ?>
                                        <option selected value="<?= $row['id'] ?>"><?= $row['name'] ?></option>
                                    <?php else : ?>
                                        <option value="<?= $row['id'] ?>"><?= $row['name'] ?></option>
                                    <?php endif ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control" id="teacher_id" name="teacher_id">
                                ...
                                <?php foreach ($teacher as $row) : ?>
                                    <?php if ($row['id'] == set_value('teacher_id')) : ?>
                                        <option selected value="<?= $row['id'] ?>"><?= $row['name'] ?></option>
                                    <?php else : ?>
                                        <option value="<?= $row['id'] ?>"><?= $row['name'] ?></option>
                                    <?php endif ?>

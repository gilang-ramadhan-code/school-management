        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?= base_url('scores/add') ?>" method="post">
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control" id="student_id" name="student_id">
                                ...
                                <?php foreach ($student as $row) : ?>
                                    <?php if ($row['id'] == set_value('student_id')) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="score" name="score" placeholder="Score" type="text" value="<?= set_value('score') ?>">
